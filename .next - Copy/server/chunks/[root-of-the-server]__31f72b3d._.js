...
(()=>{
    const e = new Error("Cannot find module '@/models/capAlertModel'");
...
async function GET(req) {
    try {
        ...
        const alerts = await CapAlert.find().sort({
            createdAt: -1
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31f72b3d._.js.map