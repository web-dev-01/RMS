...
async function POST(req) {
    try {
        ...
        const verificationCode = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomBytes(20).toString('hex');
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$sendEmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendVerificationEmail"])(email, token);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
        ...
        if (error.code === 'EAUTH') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'Email service error: Invalid credentials or setup.'
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__33ffeb97._.js.map