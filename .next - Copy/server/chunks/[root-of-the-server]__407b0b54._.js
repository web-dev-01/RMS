...
// app/api/rma/cap-alerts/route.ts
...
let capAlerts = [
    {
        ...
        title: 'Flood Warning',
        description: 'Heavy rain expected in the northern region.',
        severity: 'Severe',
        effective: '2025-08-04T10:00:00Z',
        expires: '2025-08-05T10:00:00Z'
    }
];
async function GET() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(capAlerts);
}
async function POST(req) {
    ...
    capAlerts.push(newAlert);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'CAP alert added',
        alert: newAlert
    });
}
async function DELETE(req) {
    const { id } = await req.json();
    capAlerts = capAlerts.filter((alert)=>alert.id !== id);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'CAP alert deleted',
        id
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__407b0b54._.js.map